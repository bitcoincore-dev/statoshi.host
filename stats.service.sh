...
docker build -f stats.bitcoincore.dev.dockerfile --rm -t stats.bitcoincore.dev . && docker run -e GF_AUTH_ANONYMOUS_ENABLED=true -it -p 80:3000 -p 8080:8080 -p 8125:8125 -p 8126:8126 stats.bitcoincore.dev .
