...
if STATSD_HOST != '':
    from graphite.app_settings import APPEND_SLASH, TEMPLATE_DEBUG, TEMPLATES, LANGUAGE_CODE, MEDIA_ROOT, MEDIA_URL, MIDDLEWARE_CLASSES, ROOT_URLCONF, INSTALLED_APPS, AUTHENTICATION_BACKENDS, GRAPHITE_WEB_APP_SETTINGS_LOADED, STATIC_URL, STATIC_ROOT
    MIDDLEWARE = (
